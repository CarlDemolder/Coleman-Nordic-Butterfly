...
public class SettingsActivity extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        start_Button = subTabView.findViewById(R.id.startBtn);         //Start button to start graphing and enable notifications of Selected Values
        stop_Button = subTabView.findViewById(R.id.stopBtn);           //Stop button to stop graphing and disable notifications of Selected Values
        save_Button = subTabView.findViewById(R.id.saveBtn);           //Save button to save data from enabled graph and Selected Values
